...
% and breeding program optimization. Concepts introduced in class would be reinforced through weekly computational labs and assignments that require students to write their own software to solve computational plant breeding problems. 
...
% coalescent theory, hierarchical Bayesian models, spatial variation, G$\times$E, multivariate and selection indices, longitudinal models and optimal contribution.
